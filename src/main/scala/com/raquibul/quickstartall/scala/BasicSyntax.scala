...
/**
 * This is an example objecr created based on the tutorial https://www.javatpoint.com/scala-tutorial
 * This will help you play around the basic syntax of Scala. By default I've just commented out fucntion calls insode main. 
 * You need to uncomment the functions you are going to test.   
 */
...
object BasicSyntax {
 ...
 def main(args:Array[String]) {
   println("Hello from QuickStartAll");
